        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg text-white font-semibold hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@thankatech.com" className="text-indigo-400 hover:text-indigo-300 transition-colors">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
              ...
              <div className="flex flex-col gap-2">
                <a href="#" className="text-indigo-400 hover:text-indigo-300 transition-colors text-sm">
