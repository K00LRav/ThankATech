...
export default function Footer({ onOpenRegistration }: FooterProps) {
  ...
  return (
    <footer className="relative max-w-md mx-auto px-3 sm:max-w-7xl sm:px-4 lg:px-8 mt-8 mb-4 sm:mb-8">
      <div className="bg-gradient-to-br from-slate-900/80 via-blue-900/80 to-slate-900/80 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl shadow-lg text-white overflow-hidden">
        {/* FAQ Section */}
